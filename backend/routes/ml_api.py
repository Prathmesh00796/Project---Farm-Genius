...
def recommend_crop():
    ...
    for i, p in enumerate(probs):
        candidates.append({"crop": crop_encoder.classes_[i], "probability": round(float(p), 4)})
    ...
    organic_en = {
        ...
        "10-26-26": "Use compost plus wood ash.",
        "17-17-17": "Use vermicompost and biofertilizers.",
        "20-20": "Use farmyard manure and organic compost.",
        "28-28": "Use phosphate rich organic manure.",
        "14-35-14": "Use bone meal and organic phosphorus sources.",
    }

    organic_mr = {
        "Urea": "शेणखत, गांडूळखत व जीवामृत वापरा.",
        "DAP": "हाडखत, सेंद्रिय फॉस्फरस व शेणखत वापरा.",
        "10-26-26": "कंपोस्ट व लाकडाची राख वापरा.",
        "17-17-17": "गांडूळखत व जैवखते वापरा.",
        "20-20": "शेणखत व सेंद्रिय कंपोस्ट वापरा.",
        "28-28": "सेंद्रिय फॉस्फरसयुक्त खत वापरा.",
        "14-35-14": "हाडखत व सेंद्रिय फॉस्फरस स्रोत वापरा.",
    }

    steps_mr, weather_snapshot = farming_steps_mr(crop_name, wx_flat)
    ...
    return jsonify(
        {
            ...
            "maharashtra_candidates": candidates,
            "weather_live": wx_flat.get("live"),
            "weather_city": wx_flat.get("city"),
            "farming_steps_mr": steps_mr,
            "weather_snapshot": weather_snapshot,
            "hint_mr": "AI आधारित पीक व खत शिफारस",
            "hint_en": "AI based crop and fertilizer recommendation",
        }
    )
...
def predict_yield_route():
    ...
    try:
        ...
        return jsonify({"ok": False, "error": "N, P, K, pH, rain_mm, area_ha, crop required"}), 400
    ...
    total_quintals = round(per_ha * area_ha, 3)
    ...
    total_kg = round(total_quintals * 100.0, 1)
    ...
    gross_income = round(total_kg * avg_price, 2)

    tractor_cost = round(TRACTOR_COST_PER_HA.get(crop.lower(), 3000) * area_ha, 2)

    labour_cost = round(LABOUR_COST_PER_HA.get(crop.lower(), 4000) * area_ha, 2)

    net_profit = round(gross_income - tractor_cost - labour_cost, 2)
    ...
    return jsonify(
        {
            ...
            "estimated_total_quintals_for_farm": total_quintals,
            "estimated_total_kg_for_farm": total_kg,
            "market_price": {
